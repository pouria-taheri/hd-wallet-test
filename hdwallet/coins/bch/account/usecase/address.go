...
func (a *managedAddress) PrivKey() (*bchec.PrivateKey, error) {
	...
	privKey, _ := bchec.PrivKeyFromBytes(bchec.S256(), a.prvKey)
	return privKey, nil
}
...
func newManagedAddressWithoutPrivKey(m *ScopedKeyManager, derivationPath ad.DerivationPath,
	pubKey *bchec.PublicKey, compressed bool, addrType ad.AddressType) (*managedAddress, error) {
...
func newManagedAddress(s *ScopedKeyManager, derivationPath ad.DerivationPath,
	privKey *bchec.PrivateKey, compressed bool, addrType ad.AddressType) (*managedAddress, error) {
