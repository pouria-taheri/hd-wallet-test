...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/git.mazdax.tech/blockchain/hdwallet/coins/doge/btcd/wire)
=======
...
```bash
$ go get -u git.mazdax.tech/blockchain/hdwallet/coins/doge/btcd/wire
```
