...
import (
	"git.mazdax.tech/blockchain/hdwallet/coins/ltc/btcd/txauthor"
	"git.mazdax.tech/blockchain/hdwallet/coins/ltc/btcd/txscript"
...
func (uc *signer) SpendWitnessKeyHash(
	...
	if err != nil {
		uc.logger.With(logger.Field{
			...
			"error":   err,
		}).ErrorF("cannot get pkScript from ltcutil address")
		return err
	}
